...
class PathologyCatalogController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('medical-records.catalog.pathologies', [
            'pathologyRows' => $this->pathologies->managementCatalog($clinicId, $selectedSpeciesId ?: null),
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('pathology-catalog.index', array_filter([
                'clinic_id' => $clinicId,
                'species_id' => $validated['return_species_id'] ?? null,
            ]))
            ->with('success', 'Patologia adicionada ao catálogo da clínica.');
    }
