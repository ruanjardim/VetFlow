  ...
  <div class="shell">
    <aside class="sidebar">
      ...
      <nav class="nav">
        ...
        @canany(['tutors.manage', 'patients.manage', 'medical-records.manage', 'vaccinations.manage'])
          <details class="nav-group" @if(request()->routeIs('tutores.*', 'patients.*', 'medical-records.*', 'vaccinations.*')) open @endif>
