...
@section('content')
  ...
  <div class="panel">
    <div class="table-wrap">
      <table>
        <thead><tr><th>Paciente</th><th>Responsável</th><th>Status</th><th>Leito ou setor</th><th>Admissão</th><th>Evoluções</th><th>Alta</th><th>Ações</th></tr></thead>
        <tbody>
          ...
          @empty
            <tr><td colspan="8" class="muted">Nenhuma internação registrada.</td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
